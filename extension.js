var $iq, $msg, $pres, _ , __, dayjs, converse_html, _converse, hostname = location.hostname, host = location.host, loginModal;
...
var converse_api = (function(api)
{
	...
	function setupConverse(username, repo)    {	
		console.debug("setupConverse", username, repo);
		...
		var config = {
			...
			whitelisted_plugins: ['deserve', 'jitsimeet', 'actions', 'location', 'muc-info']
		}

		if (repo) {			
			config.auto_join_rooms = [repo + '@conference.' + hostname];
		}
